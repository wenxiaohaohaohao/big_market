...
$TempDir = Join-Path $ProjectRoot 'tmp\teaching_undergraduate_v3_latex'
$MiKTeXBin = 'D:\application\miktex\miktex\bin\x64'
$XeLaTeX = Join-Path $MiKTeXBin 'xelatex.exe'
$JobName = 'EL_model_teaching_note_undergraduate_zh_v3'
...
$SourcePath = Join-Path $SourceDir "$JobName.tex"
if (-not (Test-Path -LiteralPath $SourcePath)) {
    throw "Teaching-note source not found: $SourcePath"
}
