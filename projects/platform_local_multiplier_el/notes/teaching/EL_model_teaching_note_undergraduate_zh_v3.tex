% !TEX program = xelatex
\documentclass[UTF8,11pt,scheme=chinese,fontset=windows]{ctexart}
...
\large 本科生讲义：一般需求系统与当前 M1--M3 版本\\[0.3em]
\normalsize 中文字体嵌入修正版（v3）}
...
\noindent\textbf{版本说明。}本文件是本科生讲义的中文字体嵌入修正版（v3），使用
Windows 中文 TrueType 字体生成独立 PDF，以提高不同阅读器中的兼容性。旧讲义
