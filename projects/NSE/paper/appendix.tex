...
\subsection{External-channel restriction calculation}

A consumer wedge \(\tau_C>1\) changes the effective platform price to
...
\]
The restriction can therefore induce a switch toward \(L\), but it does so by
...
equation.  The two interventions are not equivalent.
